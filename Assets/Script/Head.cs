...
namespace BigBoss
{
    ...
    public class Head : MonoBehaviour
    {
        ...
        //        transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(_runDirection), _angleSpeed);
        //}
        ...
        //    _headSpeed += _headSpeed > _minSpeed && _headSpeed < _maxSpeed ? (-1f) * transform.forward.y * Time.deltaTime : 0f;
        //}
